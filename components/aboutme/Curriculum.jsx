    ...
    <div className='mt-16 mb-8'>
        ...
        <div className='flex flex-col items-center mx-20'>
            ...
            <div className='flex flex-row m-4'>
                ...
                <hr className='w-1/12 border-black border-[1px] place-self-center mr-4 dark:border-white'/>
            ...
            <div className='flex flex-row m-4'>
                ...
                <hr className='w-1/12 border-black border-[1px] place-self-center ml-4 dark:border-white'/>
                <FaCircle className='text-[6px] place-self-center mr-2'/>
                <Image src={ParisDiderot} height={160} alt='Paris Diderot (P7) University Logo' className='rotate-90 ml-28 -mt-20 -mb-20 w-[70px] dark:w-[82px] dark:bg-white  dark:border-4 dark:border-white'/>
            </div>
            ...
            <div className='flex flex-row justify-center items-center align-middle m-4'>
                <Image src={UJF} height={60} alt='Joseph Fourier (Grenoble) University Logo' className='w-[305px] dark:bg-white'/>
