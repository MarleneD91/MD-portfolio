...
const HomeAnimatedText = () => {
  return (
    <>
      <Fade cascade damping={0.1} duration='1000' className='flex flex-col items-center justify-between'>
            ...
            <div className='text-center p-4 w-6/12'>
              ...
              <p className='font-roboto italic text-grey-txt text-sm pt-6'>N'hésitez pas à vous balader ...</p>
            </div>
      </Fade>
    </>
  )
