  ...
  return (
    <div className='flex flex-col h-screen justify-between'>
      ...
      <main className='mobiles:flex mobiles:flex-col  mobiles:items-center mobiles:-my-5'>
        <Image src={LeftSakura} width={160} alt="Illustration made by MD of a right-facing sakura branch" className='hidden mobiles:flex rotate-90 h-[180px] w-[144px] mobile-sm:h-[160px] mobile-sm:w-[128px]' priority={false} />
        ...
        <div className='flex flex-row justify-between my-6 mobiles:justify-center mobiles:mb-2'>
          <Image src={LeftSakura} width={160} alt="Illustration made by MD of a right-facing sakura branch" className='h-[200px] sm-devices:w-[120px] sm-devices:h-[150px] mobiles:hidden' priority={false} />
          <Carousel />
          <Image src={RightSakura} width={160} alt="Illustration made by MD of a left-facing sakura branch" className='h-[200px] sm-devices:w-[120px] sm-devices:h-[150px] mobiles:hidden' priority={false} />
        </div>
        ...
        <Image src={RightSakura} width={160} alt="Illustration made by MD of a left-facing sakura branch" className='hidden mobiles:flex rotate-90 h-[180px] w-[144px] mobile-sm:h-[160px] mobile-sm:w-[128px]' priority={false} />
      </main>
      <Footer/>
    </div>
  )
